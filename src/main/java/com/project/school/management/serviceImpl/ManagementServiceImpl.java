...
public class ManagementServiceImpl implements ManagementService {
	...
	public ResponseEntity<Object> saveSports(MasterSports masterSportsRequest) throws IOException {
		...
		return ResponseHandler.generateResponse("SUCCESS:Sports added successfully", HttpStatus.OK, "",
				masterSportsRequest);
	}
	...
	public ResponseEntity<Object> saveTransport(TransportEntity transportEntity) throws IOException {
		...
		return ResponseHandler.generateResponse("NOT SUCCESS: Data not added", HttpStatus.OK,
