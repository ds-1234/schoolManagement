...
(
    ...
    "wikiDataId" character varying(255) COLLATE pg_catalog."default",
    CONSTRAINT subregions_pkey PRIMARY KEY (id),
    CONSTRAINT subregions_region_id_fkey FOREIGN KEY (region_id)
...
ALTER TABLE IF EXISTS public.subregions
    OWNER to postgres;
...
CREATE INDEX IF NOT EXISTS subregions_region_id_idx
    ON public.subregions USING btree
